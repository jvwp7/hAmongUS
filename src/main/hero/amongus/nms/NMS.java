package hero.amongus.nms;

import hero.amongus.nms.entity.MountableEnderDragon;
import net.hero.services.reflection.Accessors;
import net.hero.services.reflection.acessors.FieldAccessor;
// import net.hero.services.skywars.nms.interfaces.BalloonEntity;
import net.hero.services.utils.Utils;
...
//import net.hero.services.skywars.nms.entity.*;
...
public class NMS {
    ...
    public static Entity createAttachedCart(String owner, Location location) {
        ...
        net.hero.services.nms.NMS.look(cart.getBukkitEntity(), location.getYaw(), location.getPitch());
